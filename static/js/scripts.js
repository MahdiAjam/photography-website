        ...
        if ($("#portfolio_horizontal_container").length) {
            ...
            d.imagesLoaded(function (a, b, e) {
                ...
                if ($(window).width() < 1068) {
                    ...
                    d.isotope(f);
                    d.isotope("layout");
                    const ns = $(".horizontal-grid-wrap").niceScroll({
                        cursorwidth: "0",
                        cursorborder: "none",
                    ...
                    if (rtl) {
                        $(".horizontal-grid-wrap").getNiceScroll(0).doScrollLeft($(".horizontal-grid-wrap .horizontal-portfolio_wrap").outerWidth(), 200); // Scroll X Axis
                    }
                }
                $(".gallery-filters").on("click", "a", function (a) {
                    a.preventDefault();
                    ...
                    if ($(window).width() > 1068) {
                        $('.horizontal-grid-wrap').stop(true, true).animate({
                            scrollLeft: $(".horizontal-grid-wrap .horizontal-portfolio_wrap").outerWidth()
                        }, 1200, function () {
                            d.isotope({
                                filter: b
